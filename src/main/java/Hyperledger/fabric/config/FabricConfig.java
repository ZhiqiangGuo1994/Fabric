package Hyperledger.fabric.config;
...
public class FabricConfig {
	...
	public static final String IP = "101.37.119.84";
	...
	public static final String CA_ORG3_URL = "http://" + IP + ":9054";
	
	public static final String CA_ORG4_URL = "http://" + IP + ":10054";
	...
	public static final String ORG1_PEER_1_URL = "grpc://" + IP + ":7056";

	public static final String ORG2_PEER_0 = "peer0.org2.example.com";

	public static final String ORG2_PEER_0_URL = "grpc://" + IP + ":8051";

	public static final String ORG2_PEER_1 = "peer1.org2.example.com";

	public static final String ORG2_PEER_1_URL = "grpc://" + IP + ":8056";

	/*注释掉org3和org4组织*/
	public static final String ORG3_PEER_0 = "peer0.org3.example.com";

	public static final String ORG3_PEER_0_URL = "grpc://" + IP + ":9051";

	public static final String ORG3_PEER_1 = "peer1.org3.example.com";

	public static final String ORG3_PEER_1_URL = "grpc:// " + IP + ":9056";
	
	public static final String ORG4_PEER_0 = "peer0.org4.example.com";

	public static final String ORG4_PEER_0_URL = "grpc://" + IP + ":10051";

	public static final String ORG4_PEER_1 = "peer1.org4.example.com";

	public static final String ORG4_PEER_1_URL = "grpc://" + IP + ":10056";
